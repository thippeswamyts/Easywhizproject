...
public class Multi_item_cart_order_test {
	...
	public static void main(String[] args) throws EncryptedDocumentException, IOException {
	    ...
	    FileInputStream fis2 = new FileInputStream("C:\\Users\\Dell\\Downloads\\finnalTC.xlsx");
			  ...
			  driver.findElement(By.xpath("//a[.='Apple iPhone 6 (Silver, 16 GB)']/ancestor "+ ":: div[@class=\"product-info text-left\"]/following-sibling :: div//button[@class=\"btn btn-primary\"]")).click();
